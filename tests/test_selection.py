...
def test_selection_with_non_averaged_soap():
    ...
    print(
        'SOAP Kernel for similar structure:',
        SoapDescriptor3.kernel_vector(_similar_methane()),
    )
    assert (
    ...
    print(
        'SOAP Kernel for distorted structure:',
        SoapDescriptor3.kernel_vector(_distorted_methane()),
    )
    assert (
        selector3.select
